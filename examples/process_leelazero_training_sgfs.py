...
def main(argv):    
        ...
        if line.startswith(SGF_START):
            ...
            if current_game:
                ...
                if num_games >= skip_num_games:
                    ...
                    # TODO rely on find_patterns_in_game to tell which pattern was generated by which version
    ...
    for v in versions:
        ...
        for p, c in pattern_count_by_version[v].items():
            # TODO optimize by adding count column instead of duplicating rows c times...
            for i in range(c):
